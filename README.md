...
In this case study, I opted for R to perform all steps and document my analysis effectively. The Certificate program also introduced me to other valuable tools like Spreadsheets, SQL, and Tableau.
