...
daily
Percentage of IDs that achieved 5000 steps: Count the number of IDs that have total_steps greater than or equal to 5000, divide it by the total number of IDs, and multiply by 100.

Percentage of IDs that achieved 10000 steps: Count the number of IDs that have total_steps greater than or equal to 10000, divide it by the total number of IDs, and multiply by 100.
