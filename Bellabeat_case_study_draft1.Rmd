...
knitr::opts_chunk$set(
  ...
  include = FALSE,      # SUpress code outputs
...
state (1 = asleep, 2 = restless, 3 = awake). For for details see: [Fitbit data dictionary ](https://www.fitabase.com/resources/knowledge-base/exporting-data/data-dictionaries/)
...
- These are high values for sedentary minutes. For instance, 1020 minutes equals 17 hours, and 1400 minutes equals 24 hours. After performing a quick search, it seems that the
[Fitbit uses 1400](https://community.fitbit.com/t5/Other-Charge-Trackers/sedentary-minutes/td-p/3372621) a default, sedentary minutes are recorded when the device is not worn, including sleep time.
...
ggplot(percentage_sedentary_awake_df, aes(x = Category, y = Percentage_Average)) +
  ...
  labs(x = "Average Total Sedentary Min Awake", y = "Percentage of Users", 
       ...
       subtitle = "In the 2022 study, exceeding 6 hours a day was linked to higher body fat in a representative sample.
6 hours = 360 minutes") +
  geom_text(aes(label = paste0(Percentage_Average, "%")), vjust = -0.5, color = "black") + 
  ylim(0, 100) +
  theme_minimal() +
...
- 2. Danger of prolonged sitting(sedentary time): [Association of daily sitting time and leisure-time physical activity with body fat among U.S. adults. Journal of Sport and Health Science](https://www.sciencedirect.com/science/article/pii/S2095254622001016)
