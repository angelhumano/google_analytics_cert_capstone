...
```{r}
# Option 2: Bar Plot with Error Bars
ggplot(sleep_df, aes(x = id, y = average_sleep_minutes)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "black") +
  geom_errorbar(aes(ymin = average_sleep_minutes - standard_deviation_sleep_minutes,
                    ymax = average_sleep_minutes + standard_deviation_sleep_minutes),
