...
# Step 1: Define the Threshold (e.g., using the 75th percentile)
threshold <- quantile(sleep_df$standard_deviation_sleep_hours, 0.75)

# Step 2: Filter the Data for Irregular Sleepers
irregular_sleepers <- sleep_df[sleep_df$standard_deviation_sleep_hours > threshold, ]

# Step 3: Analyze the Irregular Sleepers
summary(irregular_sleepers$standard_deviation_sleep_hours)  # Summary statistics for the standard deviation of irregular sleepers
# You can also plot histograms, box plots, or any other visualization to further analyze the sleep patterns of irregular sleepers.
